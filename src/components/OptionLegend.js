let legend = {
    default: {
        ...
        img: "sources-homepage/galerie/A110_LEGENDE_5.jpg",
        description : "The Alpine A110 Legend is true to the Alpine philosophy of absolute agility. The A110 Legend features leather seats and a glossy carbon fiber interior.",
        rims : "Legend",
        saddlery : "Black leather comfort seats",
        equipments : {
    ...
    rims : {
        ...
        legend: {
            ...
            color: {
                white :{
                    img : "configurateur/jantes/vues/couleur-blanc_jante-legende (2).jpg"
                },
                black :{
                    img : "configurateur/jantes/vues/couleur-noir_jante-legende (1).jpg"
                },
                blue :{
                    img : "configurateur/jantes/vues/couleur-bleu_jante-legende (3).jpg"
                }
            } 
    ...
    saddlery : {
        Black: {
            name : "Black leather comfort seats",
            price : 0,
            img : "configurateur/interieurs/vues/cuir-noir-1.jpg"
        },
        Brown: {
            name : "Brown leather comfort seats",
            price : 800,
            img : "configurateur/interieurs/vues/cuir-brun-1.jpg"
        },
    },     
